...
# def save_bar_plot(x, ys, xlabel, ylabel, path, title=""):
# from basic_units import cm, inch 

def save_bar_plot(results, base_mldels):
    N = 5
    ...
    avg_accs = ax.bar(ind, results[:][0], width, color='r', bottom=0)
    ...
    MAPs = ax.bar(ind + width, results[:][1], width, color='y', bottom=0)
